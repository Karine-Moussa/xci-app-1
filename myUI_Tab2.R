...
TAB2 <- tabPanel(title = "Individual Gene Search",
                 ...
                 sidebarLayout(
                     sidebarPanel(
                         ...
                         p(span(a("Fully Skewed Female (multi-tissue)", href="https://doi.org/10.1038/nature24265", target="_blank",)), style = "font-size:10px"),
                         p(span(a("Male-Female DGEA (multi-tissue)", href="https://doi.org/10.1038/nature24265", target="_blank",)), style = "font-size:10px"),
