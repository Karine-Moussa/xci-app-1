                 ...
                 sidebarLayout(
                     sidebarPanel(
                         ...
                         selectizeInput("geneofinterest2", "Gene of Interest:", unique(c(study1_genes,
                                ...
                                study6_genes, study7_genes, study8_genes, study9_genes,
                                study10_genes)), multiple = TRUE),
                         ...
                         p(span(a("Sauteraud et al. GEUVADIS (lymphoblast)", href="https://genome.cshlp.org/content/early/2021/08/23/gr.275677.121", target="_blank")), style = "font-size:10px"),
                         ...
                         p(span(a("Tukiainen et al. Fully Skewed Female (multi-tissue)", href="https://doi.org/10.1038/nature24265", target="_blank",)), style = "font-size:10px"),
                         p(span(a("Tukiainen et al. Male-Female DGEA (multi-tissue)", href="https://doi.org/10.1038/nature24265", target="_blank",)), style = "font-size:10px"),
                         p(span(a("Cotton et al. (DNA methylation multi-tissue)", href="https://doi.org/10.1093/hmg/ddu564", target="_blank",)), style = "font-size:10px"),
                         p(span(a("Baraton + Brown (Epigenetic marks in cancer and non-cancer cells)", href="https://doi.org/10.1186/s13072-021-00404-9", target="_blank",)), style = "font-size:10px"),
                         br(),
