                         ...
                         tabBox(id = "01",
                                tabPanel("Escape States", value = "1", 
                                         ...
                                         conditionalPanel( # conditional panel within conditional panel
                                             ...
                                             # Filter study and show study stats
                                             fluidRow(
                                                 column(4, offset = 0,
                                                        radioButtons("filter_study6", "Filter results",
                                                                     choices = c("Filter by searched genes (if no genes/diseases are selected, returns all genes)" = 1,
                                                                                 "Filter by displayed genes (zoom in plot)" = 2, 
                                                                                 "No filters (return all genes)" = 3),
                                                                     selected = 1),
                                                 ...
                                                 column(4, offset = 2,
                                                        br(),
                                                        p(paste(meta_stat_dt$NUM_GENES[meta_stat_dt$NUMBER == 6], "genes"), style = "font-size:16px"),
                                                        p(paste(meta_stat_dt$NUM_CALLS[meta_stat_dt$NUMBER == 6], "total calls"), style = "font-size:16px"),
                                                        p(paste(meta_stat_dt$NUM_TISS[meta_stat_dt$NUMBER == 6], "tissue(s)"), style = "font-size:16px"),
                                                 ),
                                             ),
                                         ...
                                         conditionalPanel( # conditional panel within conditional panel
                                             ...
                                             fluidRow(
                                                 column(4, offset = 0,
                                                        radioButtons("filter_study4", "Filter results",
                                                                     choices = c("Filter by searched genes (if no genes/diseases are selected, returns all genes)" = 1,
                                                                                 "Filter by displayed genes (zoom in plot)" = 2, 
                                                                                 "No filters (return all genes)" = 3),
                                                                     selected = 1),
                                                 ...
                                                 column(4, offset = 2,
                                                        br(),
                                                        p(paste(meta_stat_dt$NUM_GENES[meta_stat_dt$NUMBER == 4], "genes"), style = "font-size:16px"),
                                                        p(paste(meta_stat_dt$NUM_CALLS[meta_stat_dt$NUMBER == 4], "total calls"), style = "font-size:16px"),
                                                        p(paste(meta_stat_dt$NUM_TISS[meta_stat_dt$NUMBER == 4], "tissue(s)"), style = "font-size:16px"),
                                                 ),
                                             ),
                                             br(),
                                         ...
                                         conditionalPanel( # conditional panel within conditional panel
                                             ...
                                             fluidRow(
                                                 column(4, offset = 0,
                                                        radioButtons("filter_study5", "Filter results",
                                                                     choices = c("Filter by searched genes (if no genes/diseases are selected, returns all genes)" = 1,
                                                                                 "Filter by displayed genes (zoom in plot)" = 2, 
                                                                                 "No filters (return all genes)" = 3),
                                                                     selected = 1),
                                                 ...
                                                 column(4, offset = 2,
                                                        br(),
                                                        p(paste(meta_stat_dt$NUM_GENES[meta_stat_dt$NUMBER == 5], "genes"), style = "font-size:16px"),
                                                        p(paste(meta_stat_dt$NUM_CALLS[meta_stat_dt$NUMBER == 5], "total calls"), style = "font-size:16px"),
                                                        p(paste(meta_stat_dt$NUM_TISS[meta_stat_dt$NUMBER == 5], "tissue(s)"), style = "font-size:16px"),
                                                 ),
                                             ),
                                             br(),
                                         ...
                                         conditionalPanel( # conditional panel within conditional panel
                                             ...
                                             fluidRow(
                                                 column(4, offset = 0,
                                                        radioButtons("filter_study7", "Filter results",
                                                                     choices = c("Filter by searched genes (if no genes/diseases are selected, returns all genes)" = 1,
                                                                                 "Filter by displayed genes (zoom in plot)" = 2, 
                                                                                 "No filters (return all genes)" = 3),
                                                                     selected = 1),
                                                 ...
                                                 column(4, offset = 2,
                                                        br(),
                                                        p(paste(meta_stat_dt$NUM_GENES[meta_stat_dt$NUMBER == 7], "genes"), style = "font-size:16px"),
                                                        p(paste(meta_stat_dt$NUM_CALLS[meta_stat_dt$NUMBER == 7], "total calls"), style = "font-size:16px"),
                                                        p(paste(meta_stat_dt$NUM_TISS[meta_stat_dt$NUMBER == 7], "tissue(s)"), style = "font-size:16px"),
                                                 ),
                                             ),
                                         ...
                                         conditionalPanel( # conditional panel within conditional panel
                                             ...
                                             fluidRow(
                                                 column(4, offset = 0,
                                                        radioButtons("filter_study8", "Filter results",
                                                                     choices = c("Filter by searched genes (if no genes/diseases are selected, returns all genes)" = 1,
                                                                                 "Filter by displayed genes (zoom in plot)" = 2, 
                                                                                 "No filters (return all genes)" = 3),
                                                                     selected = 1),
                                                 ...
                                                 column(4, offset = 2,
                                                        br(),
                                                        p(paste(meta_stat_dt$NUM_GENES[meta_stat_dt$NUMBER == 8], "genes"), style = "font-size:16px"),
                                                        p(paste(meta_stat_dt$NUM_CALLS[meta_stat_dt$NUMBER == 8], "total calls"), style = "font-size:16px"),
                                                        p(paste(meta_stat_dt$NUM_TISS[meta_stat_dt$NUMBER == 8], "tissue(s)"), style = "font-size:16px"),
                                                 ),
                                             ),
                                             br(),
                                         ...
                                         conditionalPanel( # conditional panel within conditional panel
                                             ...
                                             fluidRow(
                                                 column(4, offset = 0,
                                                        radioButtons("filter_study9", "Filter results",
                                                                     choices = c("Filter by searched genes (if no genes/diseases are selected, returns all genes)" = 1,
                                                                                 "Filter by displayed genes (zoom in plot)" = 2, 
                                                                                 "No filters (return all genes)" = 3),
                                                                     selected = 1),
                                                 ...
                                                 column(4, offset = 2,
                                                        br(),
                                                        p(paste(meta_stat_dt$NUM_GENES[meta_stat_dt$NUMBER == 9], "genes"), style = "font-size:16px"),
                                                        p(paste(meta_stat_dt$NUM_CALLS[meta_stat_dt$NUMBER == 9], "total calls"), style = "font-size:16px"),
                                                        p(paste(meta_stat_dt$NUM_TISS[meta_stat_dt$NUMBER == 9], "tissue(s)"), style = "font-size:16px"),
                                                 ),
                                             ),
                                             br(),
                                         ...
                                         conditionalPanel( # conditional panel within conditional panel
                                             ...
                                             fluidRow(
                                                 column(4, offset = 0,
                                                        radioButtons("filter_study10", "Filter results",
                                                                     choices = c("Filter by searched genes (if no genes/diseases are selected, returns all genes)" = 1,
                                                                                 "Filter by displayed genes (zoom in plot)" = 2, 
                                                                                 "No filters (return all genes)" = 3),
                                                                     selected = 1),
                                                 ...
                                                 column(4, offset = 2,
                                                        br(),
                                                        p(paste(meta_stat_dt$NUM_GENES[meta_stat_dt$NUMBER == 10], "genes"), style = "font-size:16px"),
                                                        p(paste(meta_stat_dt$NUM_CALLS[meta_stat_dt$NUMBER == 10], "total calls"), style = "font-size:16px"),
                                                        p(paste(meta_stat_dt$NUM_TISS[meta_stat_dt$NUMBER == 10], "tissue(s)"), style = "font-size:16px"),
                                                 ),
                                             ),
                                             br(),
