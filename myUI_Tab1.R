                         ...
                         tabBox(title = "",
                                ...
                                tabPanel("Escape States",
                                         conditionalPanel( # conditional panel within conditional panel
                                             ...
                                             p(span(a("escape states obstained from Suppl.Table.1: doi.org/10.1038/nature24265", href="https://doi.org/10.1038/nature24265", target="_blank",)), style = "font-size:14px"),
